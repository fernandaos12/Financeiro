        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    REPETICAO = table.Column<int>(type: "int", nullable: true),
                    PERIODICIDADE = table.Column<int>(type: "int", nullable: true),
                    VALOR_PARCELA = table.Column<int>(type: "int", nullable: true),
                    NUMERO_PARCELAS = table.Column<int>(type: "int", nullable: true),
                    OBSERVACOES = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ANEXOS = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    DATA_ALTERACAO = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    STATUS = table.Column<int>(type: "int", nullable: false)
                },
